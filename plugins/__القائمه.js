...
let str = `
*🔰⚡معكم بوت روديوس التابع المملكة[BLOOD MIST] تم تصميم البوت خصيصاً للترفيه عن الاعضاء و طرد الاصنام من المملكة نأمل ان يلقى رضاكم 
*🖤🔥📆تاريخ:* ${date}
*🖤🔥🕛وقت نشط:* ${uptime}
*🖤🔥⚡مستخدمين:* ${rtotalreg}
*🖤🔥🎖️ مستوى* ${level}
